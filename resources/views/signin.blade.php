...
<body>
    ...
    <h2>Sign In</h2>
        <form action="" method="">
            ...
            <label>Confirm Email:</label><input type="email" name="email" placeholder="Confirm your Email"><br><br>
            <label>Create Password:</label><input type="password" name="password" placeholder=" Create your Password"><br><br>
            <label>Confirm Password:</label><input type="password" name="password" placeholder="Confirm Password"><br><br>
